...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      "Every asset on our platform is verified by our team to ensure our highest quality standards. Not happy? We offer a 3-day refund guarantee",
  },
  {
    name: "For the Planet",
    Icon: Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-large max-w-prose text-muted-foreground">
            Welcome to DigitalHippo. Ever asset on our platform is verified by our team to ensure
