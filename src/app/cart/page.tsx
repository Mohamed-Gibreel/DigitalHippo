...
import { Check, ClipboardTypeIcon, Loader2, X } from "lucide-react";
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          <div
            className={cn("lg:col-span-7", {
              "rounded-lg border-2 border-dashed border-zinc-200 p-12": isCartEmpty,
            })}
          >
                  ...
                  return (
                    <li key={product.id} className="flex py-6 sm:py-10">
                      ...
                      <div className="ml-4 flex flex-1 flex-col justify-center sm:ml-6">
                        <div className="relative pr-9 sm:grid sm:grid-cols-0 sm:gap-x-6 sml:pr-0">
                          <div>
                        ...
                        <p className="mt-2 flex space-x-1 text-sm text-gray-700">
