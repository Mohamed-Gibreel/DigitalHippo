          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid == true ? (
              <p className="mt-2 text-base text-muted-foreground ">
                ...
                sent your reciept and order details to{" "}
                        ...
                        <div className="flex-auto flex flex-col justify-between">
                          ...
                          {order._isPaid ? (
                            <a
                              ...
                              className="text-blue-600 hover:underline underline-offset-2 w-fit"
                            >
                              Download Asset
                            </a>
                          ) : null}
            ...
            <div>
              <div className="space-y-6 border-t border-gray-200 py-6 text-sm font-medium text-muted-foreground">
